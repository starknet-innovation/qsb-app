...
| Public checkout | `vitest run` in this checkout reported 29 files and 237 tests, and `tsc --noEmit` passed, after pinned dependency preparation. The initial public export recorded 134. | Browser/GPU tests, deployment, or a fresh withdrawal reproduced from this public checkout. |
