...
| Public checkout | `vitest run` in this checkout reported 29 files and 260 tests, and `tsc --noEmit` passed, after pinned dependency preparation. The parent checkout `2c86649` reported 28 files and 235 tests. The initial public export recorded 134. | Browser/GPU tests, deployment, or a fresh withdrawal reproduced from this public checkout. |
