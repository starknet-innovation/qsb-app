...
| Public checkout | `vitest run` in this checkout reported 28 files and 231 tests, and `tsc --noEmit` passed, after pinned dependency preparation. The parent checkout `1c34f60` reported 26 files and 217 tests. The initial public export recorded 134. | Browser/GPU tests, deployment, or a fresh withdrawal reproduced from this public checkout. |
